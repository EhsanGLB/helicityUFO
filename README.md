# helicityUFO
This is a utility function object for helicity written based on foam-extend-4.1.
...
```bash
git clone https://github.com/EhsanGLB/helicityUFO.git
cd helicityUFO/helicityUFO
wmake libso
cd ../case
```
...
## Activation
Add "libutilityFunctionObjectsHelicity.so" to case/system/controlDict/functionObjectLibs
